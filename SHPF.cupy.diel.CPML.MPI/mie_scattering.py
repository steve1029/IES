...
TF_Sx_R_calculator = rft.Sx("Sx_TF_R", "./graph/Sx", TF, (rightx, lefty, leftz), (rightx+1, righty, rightz), Src.freq, True)

TF_Sy_L_calculator = rft.Sy("Sy_TF_L", "./graph/Sy", TF, (leftx, lefty , leftz), (rightx, lefty +1, rightz), Src.freq, True)
TF_Sy_R_calculator = rft.Sy("Sy_TF_R", "./graph/Sy", TF, (leftx, righty, leftz), (rightx, righty+1, rightz), Src.freq, True)

TF_Sz_L_calculator = rft.Sz("Sz_TF_L", "./graph/Sz", TF, (leftx, lefty, leftz ), (rightx, righty, leftz +1), Src.freq, True)
TF_Sz_R_calculator = rft.Sz("Sz_TF_R", "./graph/Sz", TF, (leftx, lefty, rightz), (rightx, righty, rightz+1), Src.freq, True)
"""
