...
TF = space2D.Basic2D('TM', (Nx, Ny), (dx, dy), dt, Tsteps, np.complex64, np.complex64, method='FDTD', engine='cupy')

TF.malloc()

########## Set PML and PBC
TF.apply_PML({'x':'+-','y':'+-'}, 10)
TF.apply_BBC({'x':False,'y':False})
...
########## Point src.
setter1 = source.Setter(TF, (100*um, 140*um), (100*um+dx, 140*um+dy), mmt)
setter2 = source.Setter(TF, (200*um, 300*um), (200*um+dx, 300*um+dy), mmt)
setter3 = source.Setter(TF, (300*um, 400*um), (300*um+dx, 400*um+dy), mmt)
setter4 = source.Setter(TF, (400*um, 220*um), (400*um+dx, 220*um+dy), mmt)
